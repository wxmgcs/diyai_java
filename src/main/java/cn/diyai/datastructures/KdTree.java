...
/**
    ...
    public class KdTree
    {
        private class KdNode
        {
            ...
            KdNode( java.lang.Comparable item[ ] )
            {
                data = new java.lang.Comparable[ 2 ];
                data[ 0 ] = item[ 0 ];
                data[ 1 ] = item[ 1 ];
                left = right = null;
            }
        ...
        private KdNode insert(java.lang.Comparable[ ] x, KdNode t, int level )
        {
            if( t == null )
                t = new KdNode( x );
         ...
         * low[ 1 ] <= x[ 1 ] <= high[ 1 ].
         */
        public void printRange(java.lang.Comparable[ ] low, java.lang.Comparable[ ] high )
        {
            printRange( low, high, root, 0 );
        }

        private void printRange(java.lang.Comparable[ ] low, Comparable[ ] high,
                                KdNode t, int level )
        {
            if( t != null )
            {
