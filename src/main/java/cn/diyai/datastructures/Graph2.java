...
class Vertex
{
    ...
    java.util.LinkedList adj;    // Adjacent vertices
    int        dist;   // Cost
    Vertex     path;   // Previous vertex on shortest path

    public Vertex( String nm )
      { name = nm; adj = new java.util.LinkedList( ); reset( ); }
...
class Graph
{
    ...
    private java.util.LinkedList allVertices = new LinkedList( );  // List of vertices
    int numVertices = 0;
